...
// MASTER VERSION: VPS Database Active, Google Drive Removed, Gmail Kept for OCR
...
// SCOPES: Gmail is required for OCR, but Drive permissions are removed.
...
// --- GMAIL INTEGRATION (Restored for TransactionForm OCR) ---
